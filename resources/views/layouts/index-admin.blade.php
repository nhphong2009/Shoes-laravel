    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="/admin/brand"><i class="fa fa-circle-o"></i> Brand</a></li>
            ...
            <li><a href="/admin/size"><i class="fa fa-circle-o"></i> Size</a></li>
            <li><a href="/admin/style"><i class="fa fa-circle-o"></i> Style</a></li>
            <li><a href="/admin/productimage"><i class="fa fa-circle-o"></i> Product Image</a></li>
            <li><a href="/admin/productdetail"><i class="fa fa-circle-o"></i> Product Detail</a></li>
            <li><a href="/admin/product"><i class="fa fa-circle-o"></i> Product</a></li>
            <li><a href="/admin/orderdetail"><i class="fa fa-circle-o"></i> Order Detail</a></li>
