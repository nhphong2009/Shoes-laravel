...
@section('section')
    ...
    <div style="width: 90%; margin:auto; padding-top: 50px">
        ...
        <div class="table-responsive">
            <table class="table table-hover" id="styles-table">
                <thead>
                    <tr class="style-row">
                        <th>#</th>
                        <th>Name</th>
...
<div class="modal fade" id="modal-add">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="#" data-url="{{ route('styles.store') }}" id="form-add" method="POST" role="form">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
@section('footer')
<script type="text/javascript" charset="utf-8" src="/shoes_admin/js/style.js"></script>
@endsection